...
mkdir -p ${sim_dir}/tmp/{kmc,respect,mash} ${sim_dir}/mutated_genomes ${sim_dir}/{dbs,hists,stats,plots}/{original,mutated,ins,union} ${sim_dir}/respect_output/{original,mutated} ${sim_dir}/skims/{original,mutated} ${sim_dir}/{dbs,hists,stats,plots}/skims/{original,mutated,ins,union}
...
#echo "mutating input genomes with mutation probability of $mutation_prob"
...
#echo "making skims of genomes at various coverages..."
#bash make_skims.sh -g $genome_dir -s ${sim_dir}/skims/original -c $coverage -p 20 -l 100
#bash make_skims.sh -g ${sim_dir}/mutated_genomes -s ${sim_dir}/skims/mutated -c $coverage -p 20 -l 100
...
#bash ${scripts_dir}/build_kmer_dbs.sh -g $genome_dir -k $ksize -c $kmincov -j ${sim_dir}/tmp/kmc -o ${sim_dir}/dbs/original -t $threads
bash ${scripts_dir}/build_kmer_dbs.sh -g ${sim_dir}/mutated_genomes -k $ksize -c $kmincov -j ${sim_dir}/tmp/kmc -o ${sim_dir}/dbs/mutated -t $threads
echo "done"

echo "intersecting dbs"
bash ${scripts_dir}/combine_dbs.sh -a $original_db_dir -b ${sim_dir}/dbs/mutated -c $kmincov -e intersect -o ${sim_dir}/dbs/ins 
echo "done"
...
bash ${scripts_dir}/count_kmers.sh -d ${sim_dir}/dbs/mutated -c $kmincov -o ${sim_dir}/hists/mutated
...
python ${scripts_dir}/compute_stats.py stats --hist-dir ${sim_dir}/hists/mutated --stats-dir ${sim_dir}/stats/mutated
...
python ${scripts_dir}/compute_stats.py errors_pc --hist-dir ${sim_dir}/hists/original --ins-hist-dir ${sim_dir}/hists/ins --mutation-prob $mutation_prob --ksize $ksize --errors-dir ${sim_dir}/errors
echo "done"
